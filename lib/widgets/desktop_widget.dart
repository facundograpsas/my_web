            ...
            if (widget.project.app == null)
              PositionedDirectional(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: currentImage, fit: BoxFit.fill)),
                ),
              )
            else
              PositionedDirectional(
                ...
                child: Container(
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          currentImage =
                              AssetImage("assets/images/tvnoise.gif");
                        });
            ...
            PositionedDirectional(
              ...
              child: Container(
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      setState(() {
                        currentImage = AssetImage("assets/images/tvnoise.gif");
                      });

                      if (index > 0)
                        index--;
                      else
                        index = widget.project.images.length - 1;
